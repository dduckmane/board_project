package com.project.board.config.oauth;

import com.project.board.config.auth.PrincipalDetails;
import com.project.board.config.provider.FaceBookUserInfo;
import com.project.board.config.provider.GoogleUserInfo;
import com.project.board.config.provider.NaverUserInfo;
import com.project.board.config.provider.Oauth2UserInfo;
